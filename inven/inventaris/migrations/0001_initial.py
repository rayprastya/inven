    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.ImageField(blank=True, upload_to='static/images/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_code', models.CharField(blank=True, max_length=200, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nama_pj', models.CharField(blank=True, max_length=200, null=True)),
                ('barang_pj', models.CharField(blank=True, max_length=200, null=True)),
                ('tgl_pinjam', models.DateField()),
                ('tgl_balikin', models.DateField()),
            ],
            options={
